/**
 * WinScreen
 * WinSCreen extends Jframe and implements actionlisteners.
 ...
 * a user to replay the game or exit the system.
 * @ "Kyle Harrison"
 * @ (05/08/2011)
 */
...
{  
     ...
     * new instances of WinScreen will set the frame settings and then 
     * run the build panel method to update the frame with content.
     */
	public WinScreen()

	// setting basic propertys of lose screen
	{   
	...
	public void buildPanel()
	{
	       ...
	       JLabel StartButton = new JLabel(" You Win ",JLabel.CENTER);
	       JLabel blankPadding = new JLabel(" You Win ",JLabel.CENTER);
	       ...
	       RetryButton.addActionListener(new ReplayListener());
	...
	class ReplayListener implements ActionListener 
	{
		public void actionPerformed(ActionEvent event) 
		{
			...
			int confirmExit = JOptionPane.showOptionDialog(content,"Are you sure you would like to start a new game?","Replay Game",
